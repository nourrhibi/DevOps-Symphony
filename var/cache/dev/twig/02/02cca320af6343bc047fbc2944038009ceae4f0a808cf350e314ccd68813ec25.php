...
/* post/new.html.twig */
class __TwigTemplate_0dbc6a66eeab6e3fbff2059e71a45566274b2098c5fb8618d80e309d4f323ee8 extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    ...
    {{ form_widget(form) }}
        <button class=\"btn btn-success mt-5\">Add</button>
    {{ form_end(form) }}
{% endblock %}", "post/new.html.twig", "C:\\xampp\\htdocs\\Blog-master\\templates\\post\\new.html.twig");
    }
}
